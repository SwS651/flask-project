...
def generate_sales_report():
    ...
    for product in product_query_totals:
        ...
        pdf.cell(20, 5, f"{product.Quantity}", border=1,align='CENTER')
        pdf.cell(20, 5, product.Type_Payment, border=1,align='CENTER')
    ...
    pdf.cell(165.2, 5, "Total", border=1,align='CENTER',fill=True)
